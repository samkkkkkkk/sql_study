...
CREATE SEQUENCE dept2_seq
    ...
    MAXVALUE 10 -- 최대값 (기본값은 증가일 때는 1027, 감소일 때 -1)
    MINVALUE 1 -- 최소값 (기본값 증가일 때 1, 감소일 때 -1028)
    CACHE 5 -- 캐시메모리 사용 여부 (CACHE)
...
ALTER SEQUENCE dept2_seq INCREMENT BY -92;
...
조회를 진행할 시 인덱스의 ROWID를 통해 빠른 스캔을 가능하게 합니다.
*/
